                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select name="rentType" class="form-control">
                                                            ...
                                                            <option value="sale"
                                                                    <c:if test="${house.rentType == 'sale'}">selected</c:if>>
                                                                出售
                                                            </option>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="frm_submit_block">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <%--富文本编辑器--%>
                                                        <label>请对您将要出租的房屋进行详细描述（如配套设施、周边情况等）</label>
                                                        <textarea name="content" class="form-control ht-120"
                                                                  id="content" style="display: none;">${house.content}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="frm_submit_block">
