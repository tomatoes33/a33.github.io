...
(function ($) {
    ...
    $.fn.fileinputLocales['et'] = {
        ...
        msgSizeTooLarge: 'Fail "{name}" (<b>{size} KB</b>) 眉letab lubatu suuruse <b>{maxSize} KB</b>.',
        ...
        msgInvalidFileType: '"{name}" on vale t眉眉pi. Ainult "{types}" on lubatud.',
        ...
        msgImageWidthSmall: 'Pildi laius peab olema v盲hemalt {size} px.',
        msgImageHeightSmall: 'Pildi k玫rgus peab olema v盲hemalt {size} px.',
