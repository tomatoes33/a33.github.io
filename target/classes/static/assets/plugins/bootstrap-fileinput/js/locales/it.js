...
(function ($) {
    ...
    $.fn.fileinputLocales['it'] = {
        ...
        msgSizeTooSmall: 'Il file "{name}" (<b>{size} KB</b>) 猫 troppo piccolo, deve essere almeno di <b>{minSize} KB</b>.',
        ...
        msgFileNotReadable: 'Il file "{name}" non 猫 leggibile.',
        ...
        msgUploadAborted: 'Il caricamento del file 猫 stato interrotto',
        ...
        msgImageWidthLarge: 'La larghezza dell\'immagine "{name}" non pu貌 superare {size} px.',
        msgImageHeightLarge: 'L\'altezza dell\'immagine "{name}" non pu貌 superare {size} px.',
        msgImageResizeError: 'Impossibile ottenere le dimensioni dell\'immagine per ridimensionare.',
        msgImageResizeException: 'Errore durante il ridimensionamento dell\'immagine.<pre>{errors}</pre>',
        msgAjaxError: 'Qualcosa non ha funzionato con l\'operazione {operation}. Per favore riprova pi霉 tardi!',
        ...
        previewZoomButtonTitles: {
            ...
            borderless: 'Abilita modalit脿 senza bordi',
            close: 'Chiudi'
        }
    };
})(window.jQuery);
